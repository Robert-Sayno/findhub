            ...
            <div class="card-body p-md-2">
              <div class="row justify-content-center">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <p align="center">Already have an account? <a href="index.php" class="text-warning" style="font-weight:600; text-decoration:none;">Login</a></p>
                  <p align="center"><a href="forgot_password.php" class="text-warning" style="font-weight:600; text-decoration:none;">Forgot Password?</a></p>
                </div>

                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                  <img src="signup.svg" class="img-fluid" alt="Sample image" height="300px" width="500px">
                </div>
              </div>
            </div>
          </div>
